$(function(){
    ...
    $("#stockInventory").addClass("active");
    ...
    $("#stockInventorySubmitButton").click(function(){
        var idDom = $("#input3");
        ...
        //TODO
        $("#stockInventorySubmitForm").submit();
    });
    ...
    $("#DownloadExcel").click(function(){
        var url = "/page/stockKeep/exportInventory?";
    ...
    $("#paginationUl a").click(function(){
        ...
        if($("#stockInventorySubmitForm #hiddenPageNo").length>0){
            $("#stockInventorySubmitForm #hiddenPageNo").val(pageNo);
        }else{
            $("#stockInventorySubmitForm").append('<input name="pageNo" type="hidden" value="'+pageNo+'" id="hiddenPageNo"/>');
        }
        $("#stockInventorySubmitButton").click();
    });
